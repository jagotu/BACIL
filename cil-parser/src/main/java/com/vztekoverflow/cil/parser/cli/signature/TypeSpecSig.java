...
public class TypeSpecSig {
  ...
  private TypeSpecSig(
      ElementTypeFlag flag,
      CustomMod[] mod,
      TypeSig typeSig,
      MethodDefSig mDefSig,
      MethodRefSig mRefSig,
  ...
  public static TypeSpecSig read(SignatureReader reader, CLIFile file) {
    ...
    return new TypeSpecSig(
        flag, mod, typeSig, mDefSig, mRefSig, arrayShapeSig, genArgCount, typeArgs, genType);
  }

  public ElementTypeFlag getFlag() {
    return flag;
  }
