...
public class BytecodeInstructions {
     ...
     *
     * Maps two {@code EVALUATION_STACK_TAG}s to an {@link PrimitiveMarker}.
     * Invalid combinations result in a null.
     */
    @CompilationFinal(dimensions = 2)
    public static final PrimitiveMarker[][] binaryNumericResultTypes = new PrimitiveMarker[EVALUATION_STACK_TAG_MAX +1][EVALUATION_STACK_TAG_MAX +1];
     ...
     */
    @CompilationFinal(dimensions = 2)
    public static final PrimitiveMarker[][] binaryIntegerResultTypes = new PrimitiveMarker[EVALUATION_STACK_TAG_MAX +1][EVALUATION_STACK_TAG_MAX +1];
