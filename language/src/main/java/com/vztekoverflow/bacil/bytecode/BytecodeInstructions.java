...
public class BytecodeInstructions {
   ...
   *
   * <p>Maps two {@code EVALUATION_STACK_TAG}s to an {@link EvaluationStackPrimitiveMarker}. Invalid
   * combinations result in a null.
   */
  @CompilationFinal(dimensions = 2)
  public static final EvaluationStackPrimitiveMarker[][] binaryNumericResultTypes =
      new EvaluationStackPrimitiveMarker[EVALUATION_STACK_TAG_MAX + 1]
          [EVALUATION_STACK_TAG_MAX + 1];
  /**
   ...
   */
  @CompilationFinal(dimensions = 2)
  public static final EvaluationStackPrimitiveMarker[][] binaryIntegerResultTypes =
      new EvaluationStackPrimitiveMarker[EVALUATION_STACK_TAG_MAX + 1]
          [EVALUATION_STACK_TAG_MAX + 1];
  /**
   ...
   */
  public static void binaryNumericResult(
      byte arg1, byte arg2, EvaluationStackPrimitiveMarker result) {
   ...
   * @param result an {@link EvaluationStackPrimitiveMarker} for the resulting evaluation stack type
   */
  public static void binaryIntegerResult(
      byte arg1, byte arg2, EvaluationStackPrimitiveMarker result) {
