...
public final class BACILEngineOption {
    ...
    @Option(name = STUBBED_METHODS_NAME,
            category = OptionCategory.USER,
            stability = OptionStability.STABLE,
            help = "A list of methods to be replaced with stubs returning a default value. " +
                    "Delimited by a semicolon \'" + OPTION_ARRAY_SEPARATOR + "\'.")
    ...
    public static String[] getPolyglotOptionStubbedMethods(TruffleLanguage.Env env) {
        ...
        return "".equals(stubbedMethodsOption) ? new String[0] : stubbedMethodsOption.split(OPTION_ARRAY_SEPARATOR);
    }
}
