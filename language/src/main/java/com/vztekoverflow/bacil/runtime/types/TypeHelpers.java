...
public final class TypeHelpers {
    ...
    /**
     * Sign-extend the 8 least significant bits of the value to the 32 least significant bits, leaving the
     * 32 most significant bits zero.
     */
    ...
    /**
     * Sign-extend the 16 least significant bits of the value to the 32 least significant bits, leaving the
     * 32 most significant bits zero.
     */
