...
/**
 * Implementation of System.Math.Cos(Double)
 */
public class MathCosMethod extends JavaMethod {
    ...
    public MathCosMethod(BuiltinTypes builtinTypes, TruffleLanguage<?> language, Type definingType) {
        super(language);
