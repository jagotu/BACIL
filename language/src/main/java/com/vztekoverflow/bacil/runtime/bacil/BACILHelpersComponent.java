...
/**
 * Implementation of the BACILHelpers component, used for accessing system resources that can't be
 * accessed through the .NET methods because of incomplete implementation.
 */
public class BACILHelpersComponent extends BACILComponent {

  static AssemblyIdentity assemblyIdentity =
      new AssemblyIdentity((short) 0, (short) 0, (short) 0, (short) 0, "BACILHelpers");
  ...
  public Type findLocalType(String namespace, String name) {
    if (name.equals("BACILConsole")) return consoleType;
    else if (name.equals("BACILEnvironment")) return environmentType;
