...
/**
 * A Truffle node representing the ldsflda instruction. (III.4.15 ldsflda – load static field
 * address) Stores the resolved object type and the field from the instruction.
 */
