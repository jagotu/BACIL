...
/**
 * A Truffle node representing the ldelema instruction. (III.4.9 ldelema – load address of an
 * element of an array) Stores the resolved elementType from the instruction.
 */
  ...
  public int execute(VirtualFrame frame, long[] primitives, Object[] refs) {
    ...
    refs[top - 2] =
        new LocationReference(
            array.getFieldsHolder(), primitiveSize * index, refSize * index, elementType);
