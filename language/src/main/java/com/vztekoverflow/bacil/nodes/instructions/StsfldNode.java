...
/**
 * A Truffle node representing the stsfld instruction. (III.4.30 stsfld – store a static field of a
 * class) Stores the resolved object type and the field from the instruction.
 */
