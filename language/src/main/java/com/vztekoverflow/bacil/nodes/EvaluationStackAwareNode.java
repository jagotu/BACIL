...
/**
 * Represents a Truffle node that is aware of the BACIL evaluation stack,
...
public abstract class EvaluationStackAwareNode extends Node {
     ...
     * @param refs array representing references and {@link EvaluationStackPrimitiveMarker}s on the stack
