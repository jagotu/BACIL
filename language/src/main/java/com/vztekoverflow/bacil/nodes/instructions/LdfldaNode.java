...
/**
 * A Truffle node representing the ldflda instruction. (III.4.11 ldflda – load field address) Stores
 * the resolved object type and the field from the instruction.
 */
