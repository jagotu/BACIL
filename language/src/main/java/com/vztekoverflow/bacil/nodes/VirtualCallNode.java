...
/**
 * A Truffle node representing the callvirt instruction <b>only when the target method is actually
 * virtual</b>. (III.4.2 callvirt – call a method associated, at runtime, with an object) Stores the
 * resolved vtable slot and the root method from the instruction.
 */
