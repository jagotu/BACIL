...
/**
 * Class storing the raw CLI Metadata tables data and its metadata, as described in II.24.2.6 #~
 * stream.
 */
public class CLITables {
  ...
  public CLITables(ByteSequence tableStream) {
    ...
    tablesData =
        tableStream.subSequence(buffer.getPosition(), tableStream.length() - 1).toByteArray();
