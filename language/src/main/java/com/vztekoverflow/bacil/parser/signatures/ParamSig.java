...
/**
 * Class implementing parsing for Param and RetType, as specified in II.23.2.10 Param and II.23.2.11
 * RetType.
 *
 * <p>RetType is identical to Param except for one extra possibility, that it can include the type
 * VOID. This is implemented by the allowVoid parameter.
 */
