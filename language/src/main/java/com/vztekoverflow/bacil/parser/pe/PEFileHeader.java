...
public class PEFileHeader {
    ...
    public PEFileHeader(short machine, short numberOfSections, int timeDateStamp, int pointerToSymbolTable, int numberOfSymbols, short sizeOfOptionalHeader, short characteristics) {
    ...
    public static PEFileHeader read(ByteSequenceBuffer buf)
    {
        ...
        return new PEFileHeader(machine, numberOfSections, timeDateStamp, pointerToSymbolTable, numberOfSymbols, sizeOfOptionalHeader, characteristics);
    }
}
