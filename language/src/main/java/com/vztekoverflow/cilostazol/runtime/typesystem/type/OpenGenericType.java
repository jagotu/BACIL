...
public class OpenGenericType<T extends CLITableRow<T>> extends TypeBase<T> {
    ...
    public OpenGenericType(CILOSTAZOLContext context,
                           T row,
                           ...
                           int flags) {
        super(context, row, _definingFile, _name, _namespace, _directBaseClass, _interfaces, _definingComponent, flags);
