...
public class CILOSTAZOLLauncher extends AbstractLanguageLauncher {
  ...
  private void printFileNotFound() {
    ...
    System.out.println(
        "\t* You intended to execute a .NET program, but dotnet-" + inputFile + " does not exist.");
  }

  private void printEntryPointNotFound() {
    System.out.println(
        "Could not execute because the specified file does not contain a valid entry point.");
    System.out.println("Possible reasons for this include:");
    System.out.println(
    ...
    System.out.println(
        "\t* You intended to execute a .NET program, but " + inputFile + " is a class library.");
  }

  private void printIncompleteSource() {
    System.out.println(
        "Could not execute because the specified file contains an incomplete source.");
    System.out.println("Possible reasons for this include:");
    System.out.println(
        "\t* You intended to execute a .NET program, but "
            + inputFile
